...
# Фильтруем товары AVA QUALITY COOLING
ava_df = df[df['BrandName'] == 'AVA QUALITY COOLING'].head(5)

print(f'Найдено товаров AVA QUALITY COOLING в прайсе: {len(ava_df)}')
...
print(f'\nВсего добавлено товаров AVA QUALITY COOLING: {added}')
