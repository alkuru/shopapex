#!/usr/bin/env python3
"""
Тест изменений для артикула CA31110
...
def test_ca31110_search():
    """Тестируем поиск артикула CA31110"""
    print("=== Тест артикула CA31110 ===")
    ...
    try:
        print(f"Делаем запрос: {search_url}?q=CA31110")
        ...
        # Ищем все упоминания CA31110
        ca31110_mentions = response.text.count('CA31110')
        print(f"\nУпоминаний CA31110 на странице: {ca31110_mentions}")
...
if __name__ == "__main__":
    ...
    web_success = test_ca31110_search()
