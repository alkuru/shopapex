...
class Command(BaseCommand):
    help = 'Загружает 5 товаров бренда K-Flex из прайса AutoKontinent'

    def handle(self, *args, **options):
        """Загружает 5 товаров бренда K-Flex из прайса AutoKontinent"""
        ...
        try:
            ...
            # Проверяем результат
            total_k_flex = AutoKontinentProduct.objects.filter(brand__icontains='K-Flex').count()
            self.stdout.write(f"📋 Всего товаров K-Flex в базе: {total_k_flex}")
