...
class Command(BaseCommand):
    help = 'Загружает 5 товаров бренда Mahle из прайса AutoKontinent'

    def handle(self, *args, **options):
        """Загружает 5 товаров бренда Mahle из прайса AutoKontinent"""
        ...
        try:
            ...
            # Проверяем результат
            total_mahle = AutoKontinentProduct.objects.filter(brand__icontains='Mahle').count()
            self.stdout.write(f"📋 Всего товаров Mahle в базе: {total_mahle}")
