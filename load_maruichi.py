...
# Фильтруем товары 1-56 MARUICHI
maruichi_df = df[df['BrandName'] == '1-56 MARUICHI'].head(5)

print(f'Найдено товаров 1-56 MARUICHI в прайсе: {len(maruichi_df)}')

# Добавляем товары в базу
added = 0
for _, row in maruichi_df.iterrows():
    try:
...
print(f'\nВсего добавлено товаров 1-56 MARUICHI: {added}')
